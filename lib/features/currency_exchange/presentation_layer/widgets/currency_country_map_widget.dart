/// Displaying country flags based on currency
const Map<String, String> currencyToCountryMap = {
  'AED': 'ae', 'AFN': 'af', 'ALL': 'al', 'AMD': 'am', 'AOA': 'ao', 'ARS': 'ar',
  'AUD': 'au', 'AZN': 'az', 'BAM': 'ba', 'BDT': 'bd', 'BGN': 'bg', 'BHD': 'bh',
  'BIF': 'bi', 'BND': 'bn', 'BOB': 'bo', 'BRL': 'br', 'BWP': 'bw', 'BYN': 'by',
  'BZD': 'bz', 'CAD': 'ca', 'CDF': 'cg', 'CHF': 'ch', 'CLP': 'cl', 'CNY': 'cn',
  'COP': 'co', 'CRC': 'cr', 'CUP': 'cu', 'CVE': 'cv', 'CZK': 'cz', 'DJF': 'dj',
  'DKK': 'dk', 'DOP': 'do', 'DZD': 'dz', 'EGP': 'eg', 'ERN': 'er', 'ETB': 'et',
  'EUR': 'eu', 'FJD': 'fj', 'GBP': 'gb', 'GEL': 'ge', 'GHS': 'gh', 'GMD': 'gm',
  ...
  'SCR': 'sc', 'SDG': 'sd', 'SEK': 'se', 'SGD': 'sg', 'SOS': 'so', 'SRD': 'sr',
  'SSP': 'ss', 'STN': 'st', 'SYP': 'sy', 'SZL': 'sz', 'THB': 'th', 'TJS': 'tj',
  'TMT': 'tm', 'TND': 'tn', 'TOP': 'to', 'TRY': 'tr', 'TTD': 'tt', 'TWD': 'tw',
  'TZS': 'tz', 'UAH': 'ua', 'UGX': 'ug', 'USD': 'us', 'UYU': 'uy', 'UZS': 'uz',
  'VES': 've', 'VND': 'vn', 'VUV': 'vu', 'WST': 'ws', 'XAF': 'cm', 'XCD': 'lc',
